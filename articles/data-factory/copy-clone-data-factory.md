...
Review the guidance for creating a data factory in the Azure portal in [Create a data factory by using the Azure Data Factory UI](author-visually.md#best-practices-for-git-integration).
